...
public class DecisionRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        u_lname.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        u_lname.setForeground(new java.awt.Color(0, 102, 102));
        ...
        u_fname.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        u_fname.setForeground(new java.awt.Color(0, 102, 102));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/Vector Icono De Lectura PNG ,dibujos Icono De Educación, Conocimiento Icono, Biblioteca De Icono PNG y Vector para Descargar Gratis _ Pngtree.jpg"))); // NOI18N
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 150, 130));
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 130, 40));
        ...
        jPanel4.add(jLabel1);
        jLabel1.setBounds(20, 0, 150, 140);

        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 40, 170, 170));
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, 160, 30));

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pics/download (6) (4).jpg"))); // NOI18N
        jLabel5.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel5MouseClicked(evt);
            }
        });
        jPanel5.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 140));

        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 40, 160, 170));
